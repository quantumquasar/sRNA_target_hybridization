...
#NOTE #1: install biopython and statsmodels as standalone packages

#NOTE #2: convert to functions. if necessary break into several scripts
#one for MAPS, one for Pulse
#one for calling intaRNA
...
def load_Pulse():
	print ("load Pulse")
	Pulse_SPI1_PinT = pd.read_csv('../DataFiles_PinT/Pulse_expression/PinT pulse-expression_SPI-1.csv')
...
def exec():
	Pulse_SPI1_PinT_v1 = load_Pulse()
	MAPS_SPI1_PinT_v2 = load_MAPS()
